...
/**
 * Created by zhengpingli on 2017/6/23.
 */
@Data
public class CloanDetailResult extends GeneralResult implements Serializable {

    private static final long serialVersionUID = 1138409715263458909L;
    ...
    private List<String> orderTagList; //排序tag
